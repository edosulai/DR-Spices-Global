    ...
    <div class="contact blog">
        ...
        <div class="main-content">
            <div class="content-wrapper">
                ...
                <x-breadcrumb :navs="[['title' => 'Home', 'url' => route('home')], ['title' => 'Contact', 'url' => route('contact')]]" />
                            ...
                            <div class="row-inhert">
                                ...
                                <div class="input-contact">
                                    ...
                                    <p class="icon text-center">
                                        <a href="#">
                                            <img src="{{ asset('storage/images/other/contact_mess.png') }}" alt="img">
                                        </a>
                                    </p>
                                                ...
                                                <form action="#" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div>
                                                        <button class="btn" type="submit" name="submitMessage">
                                                            <img class="img-fl" src="{{ asset('storage/images/other/contact_email.png') }}" alt="img">Send message
                                                        </button>
                                                    </div>
                                                </form>
                                            </div>
