        ...
        <div class="row align-items-center px-3">
            ...
            <x-jet-dialog-modal wire:model="requestBuyModal">
                ...
                <x-slot name="content">
                    ...
                    <div class="mb-3">
                        <x-jet-label for="user_name" value="{{ __('Nama Pengguna') }}" />
                    ...
                    <div class="mb-3">
                        <x-jet-label for="spice_name" value="{{ __('Jenis Rempah') }}" />
                    ...
                    <div class="mb-3">
                        <x-jet-label for="created_at" value="{{ __('Waktu Pemesanan') }}" />
                    ...
                    <div class="mb-3">
                        <x-jet-label for="status_id" value="{{ __('Status Pengiriman') }}" />
