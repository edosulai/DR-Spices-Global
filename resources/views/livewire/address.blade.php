<div class="myaccount-content">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        @if ($addresses->count() < 2) <x-jet-button class="d-flex align-items-center justify-content-center w-25" wire:click="openModalAddress">
    ...
    @if ($addresses->count() < 1) <p class="saved-message">{{ __('Your Address Book is Empty') }}</p>
        @endif
